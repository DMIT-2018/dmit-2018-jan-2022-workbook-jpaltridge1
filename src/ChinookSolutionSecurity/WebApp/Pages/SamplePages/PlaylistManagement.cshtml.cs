...
namespace WebApp.Pages.SamplePages
{
    ...
    public class PlaylistManagementModel : PageModel
    {
        ...
        //query data model for playlist track info
        ...
        public void GetPlaylist()
        {
            if (!string.IsNullOrWhiteSpace(playlistname))
            {
                ...
                qplaylistInfo = _playlisttrackServices.PlaylistTrack_Fetch_Tracks(playlistname.Trim(), username);
            }
        }
        ...
        public IActionResult OnPostRemove()
        {
            try
            {
                ...
                FeedBackMessage = "Track has been removed";
        ...
        public IActionResult OnPostReOrg()
        {
            try
            {
                ...
                FeedBackMessage = "Track has been re-sequenced";
